...
class MainDialog extends ComponentDialog {
    ...
    async showCardStep(stepContext) {
        ...
        case 'PBS Card':
            await stepContext.context.sendActivity({ attachments: [this.createPBSCard()] });
            break;
        case 'Adaptive Card':
    ...
    createPBSCard() {
        return CardFactory.heroCard(
            'BotFramework PBS Card',
            CardFactory.images(['https://am-lineliff-ang-pbs.herokuapp.com/kartu.png']),
            CardFactory.actions([
                {
                    type: 'openUrl',
                    title: 'Mulai Berburu Para Pemburu Buah Sayur',
                    value: 'https://am-lineliff-ang-pbs.herokuapp.com'
                }
            ])
        );
    }
